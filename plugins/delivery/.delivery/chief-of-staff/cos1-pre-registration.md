...
| 4 | `qa-strategist` | fresh | Deciding whether a "reviewer-judged" acceptance criterion needs an automated CI check eventually, or stays manual permanently | `FR-54`'s own rewrite: "verified by human judgment, same honesty standard as `FR-10`'s design-rubric check" — already a stated, permanent position |
