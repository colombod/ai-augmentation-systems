...
> PRD: `prd.md` (this directory) · ADR: `../../decisions/ADR-001-hook-based-invocation-provenance.md`
> **Moved 2026-08-07** from the shared root `.delivery/architecture.md` into this
> initiative's own directory (`ADR-004`); previously also carried the Chief of Staff epic's
> architecture, now at `.delivery/initiatives/chief-of-staff/architecture.md`.
